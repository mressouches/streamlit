...
def convert_df(df):
    ...
    df['Default']=(df['Default']*100).astype(int).astype(str)+"%"
    df['Groupe 1 & 2 - Employee']=(df['Groupe 1 & 2 - Employee']*100).astype(int).astype(str)+"%"
    df['Groupe 3 - Employee']=(df['Groupe 3 - Employee']*100).astype(int).astype(str)+"%"
